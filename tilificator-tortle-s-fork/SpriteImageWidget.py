...
from rectangles_widget import RectanglesWidget
...
class SpriteImageWidget(QGroupBox):
    ...
    def updateOrigin(self):
        self.rectanglesWidget.originX = self.spriteImage.originX
        self.rectanglesWidget.originY = self.spriteImage.originY
        self.rectanglesWidget.redraw()
