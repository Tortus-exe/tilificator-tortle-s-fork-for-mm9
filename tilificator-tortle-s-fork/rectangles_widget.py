...
from spritetile import SpriteTile
from common import indexOfMinimum
from palettedimagewidget import PalettedImageWidget
...
class RectanglesWidget(PalettedImageWidget):
    ...
    def paintEvent(self, event):
        ...
        pen.setWidth(4)
        painter.setPen(pen)
        painter.drawEllipse(((self.padLeft + self.originX) * zoom), ((self.padTop + self.originY) * zoom), zoom, zoom)
        pen.setWidth(2)
        # Draw cutRows
        try:
            self.imageCuts
